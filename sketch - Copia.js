...
//variáveis para cordas, antiga e  novas, aluno 
var rope1, rope2, rope3;

//variáveis para restrições, antiga e novas, aluno
var fruit_con_1, fruit_con_2, fruit_con_3;

//botões antigos e novos, aluno
...
function setup() {
  ...
  //verificação para o canvas (precisa mudar), aluno
  if (isMobile) {
    canW = displayWidth;
    canH = displayHeight;
  ...
  //mudar o y para a adaptação
  bunny = createSprite(170, 850, 100, 100);
  bunny.scale = 0.2;
...
function draw() {
  ...
  //verificação para exibição de imagem (precisa mudar), aluno
  if (isMobile) {
...
//funções para cortar as cordas novas, aluno
